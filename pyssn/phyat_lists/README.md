...
`pySSN_phyat --abund_file=asplund_2009.dat --ion_frac_file=50_-2_R_ionfrac.dat --phy_cond_file=phy_cond.dat --outputcond_file=outputcond.dat` 
`--phyat_file=liste_phyat_test1.dat `

`pySSN_model --abund_file=asplund_2009.dat --ion_frac_file=50_-2_R_ionfrac.dat ` 
